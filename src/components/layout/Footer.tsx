            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm"> {/* Increased vertical spacing slightly */}
                            <li className="flex items-center gap-4">
                                <MapPin className="h-4 w-4 text-teal-500" />
                                <span>Business Center, Dubai, UAE</span>
                            </li>
                            
                            {/* Call Item - Increased horizontal gap */}
                            <li className="flex items-center gap-4"> 
                                  <Phone className="h-4 w-4 text-teal-500" />
                                <span className="w-20">Call</span> {/* Added fixed width for alignment */}
                            ...
                            {/* Whatsapp Item - Increased horizontal gap */}
                            <li className="flex items-center gap-4">
                                  <Globe className="h-4 w-4 text-teal-500" />
                                <span className="w-20">Whatsapp</span> {/* Added fixed width for alignment */}
                ...
                <div className="mt-8 pt-8 border-t border-slate-800 text-center text-xs">
                    <p>&copy; {new Date().getFullYear()} FAST WINGS TOURISM & RECREATION CONSULTANTS L.L.C.SP All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
